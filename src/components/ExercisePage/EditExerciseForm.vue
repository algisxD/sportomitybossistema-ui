...
export default {
  ...
  created() {
    this.form.name = this.exercise.pavadinimas;
    this.form.sets = this.exercise.serijuSkaicius;
    this.form.repetitions = this.exercise.pakartojimuSkaicius;
    this.form.description = this.exercise.aprasymas;
  },
  methods: {
    ...
    async createNewExercise() {
      ...
      this.exerciseForUpdate.id = this.exercise.id;
      this.exerciseForUpdate.pavadinimas = this.form.name;
      this.exerciseForUpdate.aprasymas = this.form.description;
      this.exerciseForUpdate.serijuSkaicius = this.form.sets;
      this.exerciseForUpdate.pakartojimuSkaicius = this.form.repetitions;
      this.exerciseForUpdate.treniruoteId = this.exercise.treniruoteId;
      console.log(this.exerciseForUpdate);

      await axios
        .put("pratimas/" + this.exerciseForUpdate.id, this.exerciseForUpdate)
        .then(() => {
